  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <View style={styles.centeredViewnO}>
          <View style={styles.modalViewnO}>
            <Text style={[styles.modalTextnO,{fontSize:20,fontWeight:'bold'}]}>Cumulative GPA Details</Text>
            <Text style={styles.modalTextnO}>Total Grade Points : {gradePoints}</Text>
            <Text style={styles.modalTextnO}>Total Units Taken : {units}</Text>
            <Text style={styles.modalTextnO}>Cumulative GPA : {gradePoints/units}</Text>
            <TouchableOpacity style={[styles.buttonnO, styles.buttonClosenO]} onPress={() => setModalVisible(false)}>
              <Text style={styles.textStylenO}>Close               </Text>
            </TouchableOpacity>
          </View>
        </View>
      </Modal>
      ...
      <View style={styles.form}>
        ...
        {value === '1' ? <FlatList data={completed_courses} renderItem={taken}/>: value === "2"?<FlatList data={exempted_courses} renderItem={exempted} />: value === "3"?<FlatList data={current_courses} renderItem={current}/>:<Text></Text>}
