...
<View style={styles.detailRow}>
    ...
    <Text style={styles.detailText}>College : {personal_details["College"]}</Text>
  </View>

  <View style={styles.detailRow}>

    <Text style={styles.detailText}>Credential : {personal_details["Credential"]}</Text>
  </View>


  <View style={styles.detailRow}>

    <Text style={styles.detailText}>Date of Birth : {personal_details["Date of Birth"]}</Text>
  </View>

  <View style={styles.detailRow}>

    <Text style={styles.detailText}>Major : {personal_details["Major"]}</Text>
  </View>
  ...
  <View style={styles.detailRow}>
    ...
    <Text style={styles.detailText}>Nationality : {personal_details["Nationality"]}</Text>
  </View>

  <View style={styles.detailRow}>

    <Text style={styles.detailText}>Status : {personal_details["Status"]} Program</Text>
  </View>

  <View style={styles.detailRow}>

    <Text style={styles.detailText}>Student ID : {id}</Text>
  </View>
